package com.jcchv.java.tray.notification;

import com.jcchv.java.model.CustomStage;
import com.jcchv.java.tray.animations.*;
...
public final class TrayNotification {
    ...
    private void initTrayNotification(String title, String message, NotificationType type) {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/notification/TrayNotification.fxml"));
    ...
    public void setNotificationType(NotificationType nType) {
        ...
        switch (nType) {
            ...
            case INFORMATION:
                imageLocation = getClass().getResource("/img/info.png");
                paintHex = "#2C54AB";
                break;

            case NOTICE:
                imageLocation = getClass().getResource("/img/notice.png");
                paintHex = "#8D9695";
                break;

            case SUCCESS:
                imageLocation = getClass().getResource("/img/success.png");
                paintHex = "#009961";
                break;

            case WARNING:
                imageLocation = getClass().getResource("/img/warning.png");
                paintHex = "#E23E0A";
                break;

            case ERROR:
                imageLocation = getClass().getResource("/img/error.png");
                paintHex = "#CC0033";
                break;
